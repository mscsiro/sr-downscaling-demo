...
for nw in range(len(loc_x)):
    for t in range(1, 5, n_tsteps):
        plt.scatter(samples_f[:, nw, t]*max_co2, samples_c[:, nw, t]*(max_co2-min_co2) + min_co2, c='b', marker="s", label='coarse')
        plt.scatter(samples_f[:, nw, t]*max_co2, samples_r[:, nw, t]*(max_co2-min_co2) + min_co2, c='r', marker="o", label='rec')
        plt.xlim(0, np.max(samples_f[:, nw, t])*(max_co2-min_co2) + min_co2)
        plt.ylim(0, np.max(samples_f[:, nw, t])*(max_co2-min_co2) + min_co2)
        plt.legend(loc='upper left')
        plt.plot( [0, 1*(max_co2-min_co2) + min_co2], [0, 1*(max_co2-min_co2) + min_co2], linestyle='--', color='k' )
        plt.savefig('W' + str(nw+1) + '_t_' + str(t) + '_scatter.png')
        plt.close('all')

    for n in range(n_test_calc):
        plt.plot(time_steps, samples_r[n, nw, :] * (max_co2-min_co2) + min_co2, label="rec")
        plt.plot(time_steps, samples_f[n, nw, :] * (max_co2-min_co2) + min_co2, label="fine")
        plt.plot(time_steps, samples_c[n, nw, :] * (max_co2-min_co2) + min_co2, label="coarse")
        plt.legend(loc="upper left")
    ...
    plt.plot(time_steps, np.mean(samples_r[:, nw, :]*(max_co2-min_co2) + min_co2, axis=0), label="rec")
    plt.plot(time_steps, np.mean(samples_f[:, nw, :]*(max_co2-min_co2) + min_co2, axis=0), label="fine")
    plt.plot(time_steps, np.mean(samples_c[:, nw, :]*(max_co2-min_co2) + min_co2, axis=0), label="coarse")
    plt.legend(loc="upper left")
    plt.xlabel('Time (days)', fontsize=12)
    plt.ylabel('Fraction', fontsize=12)
    ...
    plt.plot(time_steps, np.std(samples_r[:, nw, :]*(max_co2-min_co2) + min_co2, axis=0), label="rec")
    plt.plot(time_steps, np.std(samples_f[:, nw, :]*(max_co2-min_co2) + min_co2, axis=0), label="fine")
    plt.plot(time_steps, np.std(samples_c[:, nw, :]*(max_co2-min_co2) + min_co2, axis=0), label="coarse")
    plt.legend(loc="upper left")
    plt.xlabel('Time (days)', fontsize=12)
    plt.ylabel('Fraction', fontsize=12)
